...
void PrintHelp(const char *name)
{
  ...
  cout << "  deviation of <sigma>. The dimensions in which the filter recursively" << endl;
  cout << "  applied can be specified by the respective options below. Note that" << endl;
  cout << "  more than one of these options can be specified and that each can" << endl;
