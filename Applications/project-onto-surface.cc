...
{
  cout << endl;
  cout << "Usage:  " << name << " <input> <output> -image <file> [options]" << endl;
  cout << "        " << name << " <input> <output> -labels <file> [options]" << endl;
  cout << "        " << name << " <input> <output> -boundary [-nolabel-points] [-nolabel-cells] [-name <scalars>]" << endl;
  cout << endl;
  cout << "Description:" << endl;
  cout << "  Assign scalars or labels to either the vertices or the cells of a surface mesh." << endl;
  cout << "  When the input as a real-valued image, the values are linearly interpolated." << endl;
  cout << "  When the input is a segmentation labels image, the value assigned to a vertex/cell" << endl;
  cout << "  is the label of the nearest voxel in the given segmentation image. For the projection" << endl;
  cout << "  of cortical labels onto the WM/cGM or cGM/CSF boundary, use :option:`-white` or :option:`-pial`." << endl;
  cout << endl;
  cout << "Arguments:" << endl;
  ...
  cout << endl;
  cout << "Options: " << endl;
  cout << "  -image <file>                  Input real-valued scalar/vector image." << endl;
  cout << "  -labels <file>                 Input segmentation image with positive integer labels." << endl;
  cout << "  -name <name>                   Name of output scalar array. (default: Scalars or Labels)" << endl;
  cout << "  -[no]celldata                  Assign values to cells of input surface. (default: off)" << endl;
  cout << "  -[no]pointdata                 Assign values to points of input surface. (default: on)" << endl;
  cout << "  -write-dilated-labels <file>   Write image of dilated labels." << endl;
  cout << "  -pial                          Input surface is cortical cGM/CSF boundary." << endl;
  cout << "  -white                         Input surface is cortical WM/cGM boundary." << endl;
  cout << "  -min-size <n>                  Surface patches with less than n points are removed. (default: 0)" << endl;
  cout << "  -[no]fill                      Fill holes in projected surface parcellation." << endl;
