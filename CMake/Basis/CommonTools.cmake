      ...
      if (ARGN_COMPONENTS)
        ...
        foreach (CMP IN LISTS ARGN_COMPONENTS)
          ...
          if (CMPIDX EQUAL -1)
            ...
            include ("${CMAKE_BINARY_DIR}/${TOPLEVEL_PROJECT_PACKAGE_CONFIG_PREFIX}${CMP}Config.cmake")
    ...
    # look for other module of top-level project
      ...
      if (NOT PKGIDX EQUAL -1)
        ...
        if (NOT PKGIDX EQUAL -1)
          ...
          include ("${CMAKE_BINARY_DIR}/${TOPLEVEL_PROJECT_PACKAGE_CONFIG_PREFIX}${PKG}Config.cmake")
          set (${PKG}_FOUND TRUE)
        else ()
