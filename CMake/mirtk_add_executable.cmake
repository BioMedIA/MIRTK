...
function(mirtk_add_executable target_name)
  ...
  if (LANGUAGE STREQUAL CXX)
    ...
    # Whether executable depends on the Image module
    set(DEPENDS_ON_LibImage FALSE)
    ...
    endforeach ()
    # Add (optional) dependency on additional image IO libraries
    if (DEPENDS_ON_LibImage)
      if (TARGET LibNIfTI)
        basis_target_link_libraries(${target_name} LibNIfTI)
      endif ()
    endif ()
  endif ()
endfunction()
