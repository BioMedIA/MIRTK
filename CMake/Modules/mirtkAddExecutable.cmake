...
function(mirtk_add_executable target_name)
  ...
  set(LANGUAGE CXX)
  set(BINARY_LIBEXEC_DIR "${TOPLEVEL_BINARY_LIBEXEC_DIR}/${PROJECT_PACKAGE_NAME_L}")
  if (TOPLEVEL_INSTALL_LIBEXEC_DIR MATCHES "/${PROJECT_PACKAGE_NAME_L}/*$")
    set(INSTALL_LIBEXEC_DIR "${TOPLEVEL_INSTALL_LIBEXEC_DIR}")
  else ()
    set(INSTALL_LIBEXEC_DIR "${TOPLEVEL_INSTALL_LIBEXEC_DIR}/${PROJECT_PACKAGE_NAME_L}")
  endif ()
