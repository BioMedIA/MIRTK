...
.. Auto-generated by mirtk-help-rst from "mirtk calculate-exponential-map -h" output
...
::
    ...
    mirtk calculate-exponential-map <velo> <disp> [options]
    mirtk calculate-exponential-map <vx> <vy> [<vz>] <dx> <dy> [<dz>] [options]
