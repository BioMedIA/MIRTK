...
::
    ...
    mirtk average-images <output> -images <images.lst> [options]
    mirtk average-images <output> -image <image1> [-dof <dof1>] -image <image2> [-dof <dof2>]... [options]
    mirtk average-images <output> <image1> [<dof1>] <image2> [<dof2>]... [options]
    mirtk average-images <output> <sequence> [options]
