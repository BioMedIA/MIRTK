...
.. raw:: html
      ...
      <iframe src="latest/files.html" class="auto-height" width="100%" height="12000px" scrolling="no" marginheight="0" frameborder="0" onload="window.parent.parent.scrollTo(0,0)"></iframe>
      <script>
