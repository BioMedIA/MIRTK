...
using namespace ErodePointDataUtils;
...
// -----------------------------------------------------------------------------
void ErodePointData::CopyAttributes(const ErodePointData &other)
{
  _Iterations = other._Iterations;
}

// -----------------------------------------------------------------------------
ErodePointData::ErodePointData()
:
  _Iterations(1)
{
}
...
// -----------------------------------------------------------------------------
ErodePointData::ErodePointData(const ErodePointData &other)
:
...
// -----------------------------------------------------------------------------
ErodePointData &ErodePointData::operator =(const ErodePointData &other)
{
  if (this != &other) {
