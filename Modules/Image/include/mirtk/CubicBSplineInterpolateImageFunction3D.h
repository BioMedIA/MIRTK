...
#ifndef MIRTK_CubicBSplineInterpolateImageFunction3D_H
#define MIRTK_CubicBSplineInterpolateImageFunction3D_H
...
{
  mirtkObjectMacro(GenericCubicBSplineInterpolateImageFunction3D);
...
: public GenericCubicBSplineInterpolateImageFunction3D<BaseImage>
{
  mirtkObjectMacro(CubicBSplineInterpolateImageFunction3D);

public:

  /// Constructor
  CubicBSplineInterpolateImageFunction3D() {}
...
#endif // MIRTK_CubicBSplineInterpolateImageFunction3D_H
