...
{
  mirtkObjectMacro(GenericCSplineInterpolateImageFunction2D);
...
: public GenericCSplineInterpolateImageFunction2D<BaseImage>
{
  mirtkObjectMacro(CSplineInterpolateImageFunction2D);

public:

  /// Constructor
  CSplineInterpolateImageFunction2D() {}
...
#endif // MIRTK_CSplineInterpolateImageFunction2D_H 
