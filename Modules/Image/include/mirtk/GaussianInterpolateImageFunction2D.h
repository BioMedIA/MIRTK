...
#ifndef MIRTK_GaussianInterpolateImageFunction2D_H
#define MIRTK_GaussianInterpolateImageFunction2D_H
...
{
  mirtkObjectMacro(GenericGaussianInterpolateImageFunction2D);
...
: public GenericGaussianInterpolateImageFunction2D<BaseImage>
{
  mirtkObjectMacro(GaussianInterpolateImageFunction2D);
...
public:
  ...
  :
    GenericGaussianInterpolateImageFunction2D<BaseImage>(sigma)
  {}
...
#endif // MIRTK_GaussianInterpolateImageFunction2D_H
