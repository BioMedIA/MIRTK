...
#ifndef MIRTK_BSplineInterpolateImageFunction3D_H
#define MIRTK_BSplineInterpolateImageFunction3D_H
...
: public GenericBSplineInterpolateImageFunction<TImage>
{
  mirtkObjectMacro(GenericBSplineInterpolateImageFunction3D);
  mirtkGenericInterpolatorTypes(GenericBSplineInterpolateImageFunction);
...
: public GenericBSplineInterpolateImageFunction3D<BaseImage>
{
  mirtkObjectMacro(BSplineInterpolateImageFunction3D);

public:

  /// Constructor
  BSplineInterpolateImageFunction3D() {}
...
#endif // MIRTK_BSplineInterpolateImageFunction3D_H
