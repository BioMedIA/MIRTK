...
#ifndef MIRTK_LinearInterpolateImageFunction2D_H
#define MIRTK_LinearInterpolateImageFunction2D_H
...
{
  mirtkObjectMacro(GenericLinearInterpolateImageFunction2D);
...
: public GenericLinearInterpolateImageFunction2D<BaseImage>
{
  mirtkObjectMacro(LinearInterpolateImageFunction2D);

public:

  /// Constructor
  LinearInterpolateImageFunction2D() {}
...
#endif // MIRTK_LinearInterpolateImageFunction2D_H
