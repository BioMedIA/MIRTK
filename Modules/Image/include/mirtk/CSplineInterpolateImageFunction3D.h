...
#ifndef MIRTK_CSplineInterpolateImageFunction3D_H
#define MIRTK_CSplineInterpolateImageFunction3D_H
...
{
  mirtkObjectMacro(GenericCSplineInterpolateImageFunction3D);
...
: public GenericCSplineInterpolateImageFunction3D<BaseImage>
{
  mirtkObjectMacro(CSplineInterpolateImageFunction3D);
...
#endif // MIRTK_CSplineInterpolateImageFunction3D_H
