...
#ifndef MIRTK_SincInterpolateImageFunction2D_H
#define MIRTK_SincInterpolateImageFunction2D_H
...
{
  mirtkObjectMacro(GenericSincInterpolateImageFunction2D);
...
: public GenericSincInterpolateImageFunction2D<BaseImage>
{
  mirtkObjectMacro(SincInterpolateImageFunction2D);

public:

  /// Constructor
  SincInterpolateImageFunction2D() {}
...
#endif // MIRTK_SincInterpolateImageFunction2D_H
