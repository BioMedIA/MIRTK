...
#ifndef MIRTK_BSplineInterpolateImageFunction2D_H
#define MIRTK_BSplineInterpolateImageFunction2D_H
...
{
  mirtkObjectMacro(GenericBSplineInterpolateImageFunction2D);
...
: public GenericBSplineInterpolateImageFunction2D<BaseImage>
{
  mirtkObjectMacro(BSplineInterpolateImageFunction2D);
...
#endif // MIRTK_BSplineInterpolateImageFunction2D_H
