...
#ifndef MIRTK_LinearInterpolateImageFunction3D_H
#define MIRTK_LinearInterpolateImageFunction3D_H
...
{
  mirtkObjectMacro(GenericLinearInterpolateImageFunction3D);
...
: public GenericLinearInterpolateImageFunction3D<BaseImage>
{
  mirtkObjectMacro(LinearInterpolateImageFunction3D);

public:

  /// Constructor
  LinearInterpolateImageFunction3D() {}
...
#endif // MIRTK_LinearInterpolateImageFunction3D_H
