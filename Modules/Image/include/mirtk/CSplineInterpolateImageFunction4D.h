...
#ifndef MIRTK_CSplineInterpolateImageFunction4D_H
#define MIRTK_CSplineInterpolateImageFunction4D_H
...
: public GenericCSplineInterpolateImageFunction<TImage>
{
  mirtkObjectMacro(GenericCSplineInterpolateImageFunction4D);
  mirtkGenericInterpolatorTypes(GenericCSplineInterpolateImageFunction);
...
: public GenericCSplineInterpolateImageFunction4D<BaseImage>
{
  mirtkObjectMacro(CSplineInterpolateImageFunction4D);
...
#endif // MIRTK_CSplineInterpolateImageFunction4D_H
