...
#ifndef MIRTK_SincInterpolateImageFunction4D_H
#define MIRTK_SincInterpolateImageFunction4D_H
...
{
  mirtkObjectMacro(GenericSincInterpolateImageFunction4D);
...
: public GenericSincInterpolateImageFunction4D<BaseImage>
{
  mirtkObjectMacro(SincInterpolateImageFunction4D);
...
#endif // MIRTK_SincInterpolateImageFunction4D_H
